...
module.exports = {
  ...
  if(interaction.isButton()) {
    ...
    if(interaction.customId.includes(`ban`)) {
        ...
        const isim = new TextInputBuilder().setCustomId('icisim').setLabel("Oyun içi ismi:").setPlaceholder('isim').setStyle(TextInputStyle.Short)
        const sebep = new TextInputBuilder().setCustomId('sebep').setLabel("Sebep:").setPlaceholder('Neden?').setStyle(TextInputStyle.Short)
        const süre = new TextInputBuilder().setCustomId('banlayan').setLabel("Kim Banladı?:").setPlaceholder('Yetkili İsmi').setStyle(TextInputStyle.Short)
    ...
    if(interaction.customId.includes(`diger`)) {
        ...
        const isim = new TextInputBuilder().setCustomId('baslik').setLabel("Başlık:").setPlaceholder('Başlık').setStyle(TextInputStyle.Short)
        const sebep = new TextInputBuilder().setCustomId('konu').setLabel("Konu:").setPlaceholder('Konu').setStyle(TextInputStyle.Paragraph)
    ...
    if(interaction.customId.includes("sikayet")) {
      ...
      const isim = new TextInputBuilder().setCustomId('sikeden').setLabel("Şikayet Eden:").setPlaceholder('ismin').setStyle(TextInputStyle.Short)
      ...
      const olay = new TextInputBuilder().setCustomId('olay').setLabel("Olay:").setPlaceholder('Neden?').setStyle(TextInputStyle.Paragraph)
      const süre = new TextInputBuilder().setCustomId('olaydate').setLabel("Olay Tarihi.").setPlaceholder('01/01/2023').setStyle(TextInputStyle.Short)
      
      const kanıt = new TextInputBuilder().setCustomId('kanıt').setLabel("Kanıtınız:").setPlaceholder('kanıt.png').setStyle(TextInputStyle.Short)
    ...
    if(interaction.customId.includes(`basvuru`)) {
        ...
        const yas = new TextInputBuilder().setCustomId('yas').setLabel("OOC Yaşınız kaç?:").setPlaceholder('Yaş').setStyle(TextInputStyle.Short)
        const saat = new TextInputBuilder().setCustomId('saat').setLabel("Oyun içi karakter saatiniz kaç?").setPlaceholder('Saat').setStyle(TextInputStyle.Short)
        const aktif = new TextInputBuilder().setCustomId('aktif').setLabel("Gün içerisinde aktiflik süreniz kaç saat?").setPlaceholder('Günlük Aktiflik Süren').setStyle(TextInputStyle.Short)
        const sebep = new TextInputBuilder().setCustomId('sebep').setLabel("Warn/jail/ban cezanız bulunmakta mı?").setPlaceholder('Bulunmakta/Bulunmamakta').setStyle(TextInputStyle.Short)
